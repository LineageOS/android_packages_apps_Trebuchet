...
public class CustomHomeLauncher extends Launcher {
    ...
    private static class HomeAppStub {
        ...
        private HomeAppStub(int uid, ComponentName componentName, Context context, Context homeActivityContext)
            ...
            mInstance = new HomeWrapper(context, homeInterface, homeClazz.newInstance(), homeActivityContext);
        }
