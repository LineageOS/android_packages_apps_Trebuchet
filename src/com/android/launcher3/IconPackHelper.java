...
public class IconPackHelper {
    ...
    public void loadIconPack(String packageName) {
        ...
        if (TextUtils.isEmpty(packageName) || packageName.equals(defaultIcons)) {
            return;
        }
    ...
    public static void pickIconPack(final Context context, final Runnable postRunnable) {
        ...
        String iconPack = SettingsProvider.getStringCustomDefault(context, SettingsProvider.SETTINGS_UI_GENERAL_ICONS_ICON_PACK, "");
