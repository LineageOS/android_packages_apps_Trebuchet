...
public class DynamicGridSizeFragment extends Fragment implements NumberPicker.OnValueChangeListener, Dialog.OnDismissListener{
    ...
    private void showNumberPicker() {
        ...
        nPRows.setMinValue(Math.max(1, rows - DeviceProfile.GRID_SIZE_MIN));
        ...
        nPColumns.setMinValue(Math.max(1, columns - DeviceProfile.GRID_SIZE_MIN));
