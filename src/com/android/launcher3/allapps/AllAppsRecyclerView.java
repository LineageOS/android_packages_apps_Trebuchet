...
public class AllAppsRecyclerView extends BaseRecyclerView
    ...
    public String scrollToPositionAtProgress(float touchFraction) {
        ...
        if (mFastScrollMode == FAST_SCROLL_MODE_JUMP_TO_FIRST_ICON) {
            ...
            // If the first item in this section is not fully visible, we should scroll to it.
            LinearLayoutManager layoutManager = (LinearLayoutManager) getLayoutManager();
            int firstVisiblePosition = layoutManager.findFirstCompletelyVisibleItemPosition();
            if (mPrevFastScrollFocusedPosition < firstVisiblePosition) {
                layoutManager.smoothScrollToPosition(this, null, mPrevFastScrollFocusedPosition);

            // Otherwise, lets scroll such that the last item is fully visible.
            } else {
                int lastSectionItemPosition = mPrevFastScrollFocusedSection.numApps + mPrevFastScrollFocusedPosition - 1;
                layoutManager.smoothScrollToPosition(this, null, lastSectionItemPosition);
            }
