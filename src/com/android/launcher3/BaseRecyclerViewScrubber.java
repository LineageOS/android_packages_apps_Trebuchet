...
public class BaseRecyclerViewScrubber extends LinearLayout {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case MSG_SET_TARGET:
                    ...
                    int realIndex = msg.arg2;
                    performSetTarget(adapterIndex, realIndex);
    ...
    private void sendSetTargetMessage(int adapterIndex, int realIndex) {
    ...
    private void performSetTarget(int adapterIndex, int lastIndex) {
        mBaseRecyclerView.scrollToSection(mSectionContainer.getSectionName(adapterIndex));
    }
    ...
    private void performAnimatePickMessage(int index, int width, int lastIndex) {
        if (mScrubberIndicator != null) {
            ...
            String sectionText = mSectionContainer.getSectionName(directionalIndex);
    ...
    private static class SectionContainer {
        private ArrayList<BaseRecyclerViewScrubberSection> mSections;
        private String[] mSectionNames;

        public SectionContainer(String[] headers) {
            mSections = BaseRecyclerViewScrubberSection.createSections(headers);
            mSectionNames = headers;
        }
        ...
        public String getSectionName(int idx) {
            ...
            return showLetters() ? mSections.get(idx).getText() : mSectionNames[idx];
        }
    ...
    public void updateSections() {
        if (mBaseRecyclerView != null) {
            mSectionContainer = new SectionContainer(mBaseRecyclerView.getSectionNames());
    ...
    private class ScrubberAnimationState implements SeekBar.OnSeekBarChangeListener {
        ...
        private void progressChanged(SeekBar seekBar, int index, boolean fromUser) {
            ...
            sendSetTargetMessage(adapterIndex, index);
