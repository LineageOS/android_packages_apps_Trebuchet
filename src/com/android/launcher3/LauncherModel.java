                        ...
                        try {
                            ...
                            case LauncherSettings.Favorites.ITEM_TYPE_APPWIDGET:
                                ...
                                if (!isSafeMode && (provider == null || provider.provider == null ||
                                    ...
                                    if (savedComponent != null && (!isValidPackageComponent(
                                            manager, savedComponent) || isPackageDisabled(
                                                    manager, savedComponent.getPackageName()))) {
                                        // Don't delete disabled components
                                        String log = "Widget that is disabled: id="
