...
public class SearchLauncherCallbacks implements LauncherCallbacks, OnSharedPreferenceChangeListener {
    ...
    SearchLauncherCallbacks(Launcher launcher) {
        mLauncher = launcher;
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        OverlayCallbackImpl overlayCallback = new OverlayCallbackImpl(mLauncher);
        mLauncherClient = new LauncherClient(mLauncher, overlayCallback, getClientOptions(prefs));
        overlayCallback.setClient(mLauncherClient);
    ...
    public List<ComponentKeyMapper<AppInfo>> getPredictedApps() {
        return mLauncher.getPredictiveAppsList();
    }
