...
public class FolderIcon extends FrameLayout implements FolderListener {
    ...
    public static class FolderRingAnimator {
        ...
        public FolderRingAnimator(Launcher launcher, FolderIcon folderIcon) {
            ...
            if (sStaticValuesDirty) {
                ...
                sSharedOuterRingDrawable = res.getDrawable(R.drawable.folder_container_highlight);
                sSharedInnerRingDrawable = res.getDrawable(R.drawable.folder_container);
                sSharedFolderLeaveBehind = res.getDrawable(R.drawable.folder_container);
    ...
    public void showFolderAccept() {
        setPreviewBackground(R.drawable.folder_container_highlight);
    }

    public void hideFolderAccept() {
        setPreviewBackground(R.drawable.folder_bg);
    }
