...
public class SettingsActivity extends Activity {
    ...
    public static class LauncherSettingsFragment extends PreferenceFragment
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            updateDefaultHomescreenPreferenceEntries((ListPreference)homeGroup.findPreference(KEY_DEFAULT_HOMESCREEN_ID));
        ...
        public void onResume() {
            ...
            updateDefaultHomescreenPreferenceEntries((ListPreference) findPreference(KEY_DEFAULT_HOMESCREEN_ID));
        }
        ...
        public void onSharedPreferenceChanged(SharedPreferences prefs, String key) {
            switch (key) {
                ...
                case KEY_DEFAULT_HOMESCREEN_ID:
                    ListPreference defaultHomescreenPreference = (ListPreference) findPreference(KEY_DEFAULT_HOMESCREEN_ID);
        ...
        private void updateDefaultHomescreenPreferenceEntries(ListPreference preference) {
            if (preference != null) {
                ...
                for(int i = 1; i < pageCount +1; i++) {
                    prefEntries[i] = Integer.toString(i);
                }
