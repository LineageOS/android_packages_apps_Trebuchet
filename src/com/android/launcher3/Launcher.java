    ...
    private void startShortcutIntentSafely(Intent intent, Bundle optsBundle, ItemInfo info) {
        try {
            ...
            try {
                ...
                if (info.itemType == LauncherSettings.Favorites.ITEM_TYPE_DEEP_SHORTCUT && info instanceof ShortcutInfo && ((ShortcutInfo) info).useNativeShortcut) {
    ...
    public void startEdit(ItemInfo info, ComponentName component) {
        ...
        mIconEditDialog = new AlertDialog.Builder(this)
                ...
                .setNeutralButton(R.string.icon_pack_reset, (dialog, which) ->
                        mIconCache.updateIconForActivity(info.getIntent(), info.user))
