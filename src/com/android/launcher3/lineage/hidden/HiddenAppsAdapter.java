...
class HiddenAppsAdapter extends RecyclerView.Adapter<HiddenAppsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        viewHolder.bind(mList.get(i), mListener);
    }
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(HiddenComponent component, Listener listener) {
            ...
            mLockView.setImageResource(component.isHidden() ?
                    R.drawable.avd_hidden_unlock : R.drawable.avd_hidden_lock);
            ...
            itemView.setOnClickListener(v -> {
                ...
                listener.onItemChanged(component);
            });
        }
    }
