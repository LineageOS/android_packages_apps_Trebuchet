...
public class TrustAppsActivity extends Activity implements
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        findMenuItems.inflate(R.menu.menu_trust_apps, menu);
    ...
    private void showOnBoarding(boolean forceShow) {
        ...
        View dialogView = getLayoutInflater().inflate(R.layout.dialog_trust_welcome, null,false);
