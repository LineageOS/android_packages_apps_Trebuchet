...
public class OverviewSettingsPanel {
    ...
    public void initializeAdapter() {
        ...
        PinnedHeaderListView listView = (PinnedHeaderListView) mLauncher
    ...
    public void update() {
        ...
        widgetButton.setVisibility(!isAllAppsVisible ? View.VISIBLE
                : View.GONE);
        themesButton.setVisibility(!isAllAppsVisible ? View.VISIBLE
                : View.GONE);
        wallpaperButton.setVisibility(!isAllAppsVisible ? View.VISIBLE
                : View.GONE);
        defaultHomePanel.setVisibility((!isAllAppsVisible && pagedView.getPageCount() > 1) ?
