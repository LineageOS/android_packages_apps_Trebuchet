...
public class LauncherStats {
    ...
    public static final String ORIGIN_TREB_LONGPRESS = "trecbuchet_longpress";
    ...
    private static class WriteHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            Logger.logd(TAG, "Handling message: " + msg.what);
            switch (msg.what) {
    ...
    private void sendStoreEventMessage(TrackingEvent trackingEvent) {
        Logger.logd(TAG, "Sending tracking event to handler: " + trackingEvent);
    ...
    private static void handleStoreEvent(TrackingEvent trackingEvent) {
        Logger.logd(TAG, "Handling store event: " + trackingEvent);
        if (trackingEvent != null) {
            sDatabaseHelper.writeEvent(trackingEvent);
        } else {
            Logger.loge(TAG, "Tracking event was null!");
        }
    }
