...
public class AppDrawerListAdapter extends RecyclerView.Adapter<AppDrawerListAdapter.ViewHolder>
    ...
    private void initParams() {
        mIconParams = new
                ...
                mDeviceProfile.folderCellHeightPx);
        mSpacerParams = new
    ...
    public void populateByCharacter(ArrayList<AppInfo> info) {
        ...
        for (int i = 0; i < appInfos.size(); i += mDeviceProfile.numColumns) {
            int endIndex = (int) Math.min(i + mDeviceProfile.numColumns, appInfos.size());
