...
public class DynamicGrid {
    ...
    public DynamicGrid(Context context, Resources resources,
        ...
        deviceProfiles.add(new DeviceProfile("Nexus 7",
                575, 904,  5, 6, (useLargeIcons ? 76 : 58), 14.4f,  7, (useLargeIcons ? 64 : 50),
                R.xml.default_workspace_5x6, R.xml.default_workspace_5x6_no_all_apps));
        // Larger tablet profiles always have system bars on the top & bottom
        deviceProfiles.add(new DeviceProfile("Nexus 10",
                727, 1207,  5, 6,  (useLargeIcons ? 80 : 62), 14.4f,  7, (useLargeIcons ? 68 : 54),
                R.xml.default_workspace_5x6, R.xml.default_workspace_5x6_no_all_apps));
        deviceProfiles.add(new DeviceProfile("20-inch Tablet",
                1527, 2527,  7, 7,  (useLargeIcons ? 104 : 78), 20,  7, (useLargeIcons ? 76 : 62),
