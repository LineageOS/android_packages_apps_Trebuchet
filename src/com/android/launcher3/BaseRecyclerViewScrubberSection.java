...
public class BaseRecyclerViewScrubberSection {
    ...
    private static int getFirstValidIndex(ArrayList<BaseRecyclerViewScrubberSection> sections) {
    ...
    private static void createIndices(ArrayList<BaseRecyclerViewScrubberSection> sections) {
    ...
    public static ArrayList<AutoExpandTextView.HighlightedText> getHighlightText(
            ArrayList<BaseRecyclerViewScrubberSection> sections) {
        if (sections == null) {
            return null;
        }
    ...
    private static void addAlphaLetters(ArrayList<BaseRecyclerViewScrubberSection> sections,
     ...
     */
    public static ArrayList<BaseRecyclerViewScrubberSection> createSections(String[] sectionNames) {
        ...
        ArrayList<BaseRecyclerViewScrubberSection> sections = new ArrayList<>(sectionNames.length);
        ...
        BaseRecyclerViewScrubberSection.createIndices(sections);
