...
import com.android.launcher3.shortcuts.util.MapHashMap;
import com.android.launcher3.shortcuts.util.MultiHashMap;
...
public class ShortcutCache {
    ...
    public ShortcutCache(Context context, LauncherApps launcherApps) {
        ...
        if (c.getCount() == 0) {
            List<LauncherActivityInfo> infoList = launcherApps.getActivityList(null, Process.myUserHandle());
