...
public class HiddenAppsActivity extends ListActivity implements MenuItem.OnMenuItemClickListener {
    ...
    private void save() {
        if (!mSaved) {
            ...
            editor.putString(SettingsProvider.SETTINGS_UI_DRAWER_HIDDEN_APPS, string.toString());
    ...
    private void restore() {
        ...
        String[] flattened = SettingsProvider.Interface.Drawer.getHiddenApps(this).split("\\|");
