 ...
 *
 * @author Artem Shvadskiy <ashvadskiy@cyngn.com> on 12/9/15.
 */
    ...
    private void showRemoteFolder() {
        ...
        if (findNewSpace) {
            Pair<Long, int[]> space = LauncherModel.findNextAvailableIconSpace(mLauncher, null,
                    null, 0, new ArrayList<Long>(mLauncher.getWorkspace().getWorkspaceScreenIds()));
            screen = space.first;
            cell = space.second;
        ...
        if (mRemoteFolder == null) {
            ...
            mLauncher.getWorkspace().addInScreen(mRemoteFolder, container, screen,
