...
public class HotwordServiceClient {
        ...
        private void internalBind() {
                ...
                mIsAvailable = mActivity.bindService(localIntent, mConnection,
        ...
        public final void onAttachedToWindow() {
                ...
                assertMainThread();
                mActivity.getWindow().getDecorView().getWindowId().registerFocusObserver(
                                                                         mFocusObserver);
                internalBind();
        }
        ...
        public final void onDetachedFromWindow() {
                ...
                assertMainThread();
                mActivity.getWindow().getDecorView().getWindowId().unregisterFocusObserver(
                                                                           mFocusObserver);
