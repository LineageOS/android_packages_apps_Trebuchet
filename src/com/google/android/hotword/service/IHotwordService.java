...
public abstract interface IHotwordService extends IInterface {
        public abstract void requestHotwordDetection(String packageName, boolean detect)
        ...
        public static abstract class Stub extends Binder implements IHotwordService {
                ...
                private static class Proxy implements IHotwordService {
                        ...
                        public void requestHotwordDetection(String packageName, boolean detect)
                        throws RemoteException {
                                ...
                                try {
                                        ...
                                        mRemote.transact(TRANSACTION_requestHotwordDetection, data,
                                                                                null, FLAG_ONEWAY);
                                } finally {
                                        data.recycle();
                                }
