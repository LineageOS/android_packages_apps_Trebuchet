...
public class Stats {
    ...
    public static final String ACTION_LAUNCH = "com.cyanogenmod.trebuchet.action.LAUNCH";
    public static final String PERM_LAUNCH = "com.cyanogenmod.trebuchet.permission.RECEIVE_LAUNCH_BROADCASTS";
