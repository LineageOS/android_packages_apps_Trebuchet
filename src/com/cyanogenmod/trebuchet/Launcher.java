...
public final class Launcher extends Activity
    ...
    private boolean mLockedWorkspace;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLockedWorkspace = PreferencesProvider.Interface.General.getLockedWorkspace(getResources().getBoolean(R.bool.locked_workspace));
        ...
        if (allowLongPress && !mDragController.isDragging()) {
            if (itemUnderLongClick == null) {
                ...
                if (!(itemUnderLongClick instanceof Folder)) {
                    ...
                    if (mLockedWorkspace) return false;
    ...
    boolean isLockedWorkspace() {
        return mLockedWorkspace;
    }
