                ...
                if (foundCell) {
                    ...
                    if (info.id != ItemInfo.NO_ID) {
                        ...
                        if (!LauncherApplication.isScreenLandscape(getContext())) {
                            PreferencesProvider.Interface.Homescreen.setDefaultHotseatIcon(getContext(), lp.cellX);
                        } else {
                            PreferencesProvider.Interface.Homescreen.setDefaultHotseatIcon(getContext(), lp.cellY);
                        }
                    }
                } else {
