...
public class InfoDropTarget extends ButtonDropTarget {
    ...
    protected void onFinishInflate() {
        ...
        boolean mTransposeHotseat = getResources().getBoolean(R.bool.hotseat_transpose_layout_with_orientation);
        if (orientation == Configuration.ORIENTATION_LANDSCAPE && mTransposeHotseat) {
            setText("");
        }
    }
