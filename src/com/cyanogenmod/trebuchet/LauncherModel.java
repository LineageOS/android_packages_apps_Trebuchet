...
public class LauncherModel extends BroadcastReceiver {
    ...
    private class LoaderTask implements Runnable {
        ...
        private void removeHiddenAppsWorkspaceItems(
            ...
            String[] flattened = SettingsProvider.
            		getStringCustomDefault(context, "ui_drawer_hidden_apps", "").split("\\|");
            ...
            boolean removeShortcutsOfHiddenApps = SettingsProvider.
            		getBooleanCustomDefault(context, "ui_drawer_remove_hidden_apps_shortcuts", true);

            boolean removeHiddenAppsWidgets = SettingsProvider.
            		getBooleanCustomDefault(context, "ui_drawer_remove_hidden_apps_widgets", true);

            // Shortcuts
            if (removeShortcutsOfHiddenApps) {
