...
import com.cyanogenmod.trebuchet.AutoInstallsLayout.LayoutParserCallback;
...
import com.cyanogenmod.trebuchet.config.ProviderConfig;
...
public class LauncherProvider extends ContentProvider {
    ...
    private static String getAttributeValue(XmlResourceParser parser, String attribute) {
        String value = parser.getAttributeValue(
                "http://schemas.android.com/apk/res-auto/com.cyanogenmod.trebuchet", attribute);
        if (value == null) {
