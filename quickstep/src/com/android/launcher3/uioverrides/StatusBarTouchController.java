...
public class StatusBarTouchController implements TouchController {
    ...
    protected final TouchEventTranslator mTranslator = new TouchEventTranslator(this::dispatchTouchEvent);
    ...
    public final boolean onControllerInterceptTouchEvent(MotionEvent ev) {
        ...
        if (action == MotionEvent.ACTION_DOWN) {
            ...
            mTranslator.reset();
            mTranslator.setDownParameters(MotionEvent.ACTION_DOWN, ev);
    ...
    private boolean canInterceptTouch(MotionEvent ev) {
        if (mLauncher.isInState(LauncherState.NORMAL) && mSharedPreferences.getBoolean(PREF_STATUSBAR_EXPAND, true)) {
